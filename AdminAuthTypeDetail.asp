...
strGoTo = "AdminAuthTypeList.asp"   ' asp page to return to once record is deleted
strTabID = "atpID"              ' key field name for table        
...
set objPara = objCmd.CreateParameter ("RecID",3,1,5, request("atpID"))
...
objCmd.CommandText = "spAuthTypeDel"
    		...
    		<td>
    			<!--#include file="Includes/Header.inc"-->
                    ...
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Authorisation Type Details</strong></font></td>
                    </tr>
    								...
    								<td>
    									<table border=0 cellpadding=0 cellspacing=0>
                                        	<tr>
                                                ...
                                                -->
                                                <td width=20><a class=itemfontlink href="AdminAuthTypeEdit.asp?atpID=<%=request("atpID")%>"><img class="imagelink" src="images/editgrid.gif"></A></td>
                                                <td class=toolbar valign="middle">Edit Authorisation Type</td>
												<% if strDelOK = "0" then %>
                                                	<td class=titleseparator valign="middle" width=14 align="center">|</td>
                                                	<td width=20><a class=itemfontlink href="DeleteRec.asp?RecID=<%=request("atpID")%>&TableName=<%=strTable%>&TabId=<%=strTabID%>&GoTo=<%=strGoTo%>" onClick="javascript:return(checkDelete());"><img class="imagelink" src="images/delitem.gif"></A></td>
                                                	<td class=toolbar valign="middle">Delete Authorisation Type</td>
												<% end if %>    
                                                <td class=titleseparator valign="middle" width=14 align="center">|</td>
    								...
    								<td>
    									<table width=100% border=0 cellpadding=0 cellspacing=0>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td valign="middle" width=85% class=itemfont><%=rsRecSet("authType")%></td>
                                            </tr>
											<tr height=16>
                                            	<td colspan="3">&nbsp;</td>
                                            </tr>
