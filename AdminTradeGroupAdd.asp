...
<body>
<form  action="UpdateTradeGroup.asp?strAction=<%=strAction%>&strTable=<%=strTable%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"-->
  	   <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Add New Trade Group</strong></font></td>
                    </tr>
				  ...
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85%><INPUT class="itemfont" style="WIDTH: 50px" maxLength=50 name=txtTG id="txtTG" Value=""></td>
                      </tr>
                      <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
						<td valign="middle" width=13%>Description:</td>
						<td valign="middle" width=85%><INPUT class="itemfont" style="WIDTH: 360px" maxLength=300 name=txtdescription id="txtdescription" Value=""></td>
					  </tr>
					  <tr height=16>
					    <td></td>
					  </tr>
