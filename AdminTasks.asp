		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
    	  <tr >
      	    <td align="center" class="sidemenuwidth" ><img alt="" src="images/spssites.gif" ></td>
       		<td  class=titlearea >Tasks<BR>
       		<span class="style1"><Font class=subheading>Tasks</Font></span></td>
    	  </tr>
  		  <tr>
  		...
  		<table width=100% height='<%=session("heightIs")%>px' border=0 cellpadding=0 cellspacing=0 > 
      	  <tr valign=Top>
            <td class="sidemenuwidth" background="Images/tableback.png"><!--#include file="Includes/TaskMenu.inc"--></td>
			<td width=16></td>
		    <td align=left >
			  <table border=0 cellpadding=0 cellspacing=0 width=100%>
				<tr height=16 class=SectionHeader>
				  <td>
				     <table border=0 cellpadding=0 cellspacing=0 width=100%>
							<tr height=16 class=SectionHeader>
							  <td width="12%" class=toolbar>Tasks</td>
							</tr>
					</table>
				    <table border=0 cellpadding=0 cellspacing=0 width=100% class=MenuStyleParent>
					  ...
					  <tr height=16>
					    <td class=toolbar>&nbsp;</td>
				        <td class=toolbar><A title="" href="AdminPsTasks.asp">Personnel Tasks </a></td>
					    <td class=toolbar>&nbsp;</td>
					    <td class=toolbar>&nbsp;</td>
					  </tr>
					 </table>				  </td>
