...
radSta=0
if request("radSta") = "on" then
  radSta=1
end if

radMap=0
if request("radmap") = "on" then
  radMap=1
end if
...
objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter("@sta", 11, 1, 1, radSta)
objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter("@map", 11, 1, 1, radMap)
objCmd.Parameters.Append objPara
