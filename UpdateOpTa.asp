...
IF strAction = "Update" THEN
    strCommand = "spOpTaUpdate"
    strGoTo = "AdminOpTaDetail.asp?RecID=" & request("RecID")
ELSEIF  strAction = "Add" THEN
    strCommand = "spOpTaInsert"
	strGoTo = "AdminOpTaAdd.asp"
ELSE
...
'objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter ("Name",200,1,100, request("txtaction"))
objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter ("OpCat",3,1,0, strTaskID)
objCmd.Parameters.Append objPara
