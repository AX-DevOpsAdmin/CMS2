...
strRecid = "staffID"
strCommand = "spAdminPeRsAuthCurrent"
...
'response.write(request("staffID")&", "&request("atpID"))
'response.end()
...
<body>
    <form action="AdminAddAuthLims.asp" method="post" name="frmDetails">
                                                        ...
                                                        <table class="authlim" border=0 cellpadding=0 cellspacing=0 width=75%>
                                                            ...
                                                            <% if rsRecSet.recordcount > 0 then %>
                                                                <% do while not rsRecSet.eof %>
                                                                    <tr>
                                                                        <td width="39%" height="22px" align="left" class="toolbar" onClick="authlim(this, <%=rsRecSet("staffID")%>,<%=rsRecSet("asrID")%>,<%=rsRecSet("lvlID")%>);"><a class="itemfontlink" ><%=rsRecSet("authlevel")%></a></td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                                                            <tr class="SectionHeader toolbar">
                                                                                <td height="25px" align="left">Current Assessments</td>
                                                                                <td height="25px">&nbsp;</td>
                                                                                <td height="25px" align="left">Assessments Available</td>
                                                                                <td height="25px">&nbsp;</td>
                                                                                <td height="25px" align="left">Assessments to Add</td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td class="ColorBackground">
                                                                                   <div id="authlims">
                                                                                    <select name="limsAdded" size="10" multiple class="pickbox" style="width:180px;" id="limsAdded" > 
...
<script language="javascript">
  ...
  function authlim(obj, recID, asrID, lvlID)
{
	...
	else
	{
		...
		document.frmDetails.authlevel.value = lvlID;
		
		 var str = 'recID='+recID + '&asrID='+asrID;
	     ajax('ddGetAuthLims.asp',str,'authlims');

         var str = 'recID='+recID + '&asrID='+asrID;
		 //alert(str);
	     ajax('ddGetAuthLimsList.asp',str,'authlist');
...
{	
	...
	else
	{
        ...
        //alert("Auth is " + newattached + " * " + newdatesattached);
		document.frmDetails.hiddenChange.value = "";
