...
<body>
<form action="UpdateDental.asp?strAction=<%=strAction%>" method="post" name="frmDetails">
      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Dental Details</strong></font></td>
                    </tr>
  		  <tr>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminDentalDetail.asp?recID=<%=request("recID")%>">Back</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
