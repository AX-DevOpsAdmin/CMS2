          ...
          <!--#include file="Includes/Header.inc"--> 
  		 <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Seperated Service Codes</strong></font></td>
                    </tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td width=20><a class=itemfontlink href="AdminSSCAdd.asp"><img class="imagelink" src="images/newitem.gif"></a>							                                 </td>
							  <td valign="middle" class=toolbar>New Separated Service Code</td>
							</tr>  
					      </table>
					    ...
					    <td>
						  <table width="100%" border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=30>
							  ...
							  <td valign="middle" width=8%>Code</td>
							  <td valign="middle" width=90%>Description </td>
							</tr>
						  	<tr>
       						  <td colspan=3 class=titlearealine  height=1></td> 
     					    </tr>
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet("sscID")%>" height=30>
								<td valign="middle" width=2%>&nbsp;</td>
								<%   ' make sure SSC shows as 2 digits
								...
								%>
	                            <td valign="middle" width="8%"><a class=itemfontlink href="javascript: subForm(<%=rsRecSet("sscID")%>)"><%=strcode%></a></td> 
				                <td valign="middle" width="90%"><%=rsRecSet("description")%></td> 
						      </tr>
  							  <tr>
       						    <td colspan=3 class=titlearealine  height=1></td> 
     						  </tr>
...
function subForm(recID){
     document.forms.frmDetails.action = "AdminSSCDetail.asp";
