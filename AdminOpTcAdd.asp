...
<body>
<form  action="UpdateOpTc.asp?strAction=<%=strAction%>&strTable=<%=strTable%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"-->
    	  ...
    	  <tr >
      		<td align="center" width=200 ><img alt="" src="images/spssites.gif" ></td>
   		    ...
   		    <span class="style1"><Font class=subheading>New Op Task Category </Font></span></td>
    	  </tr>
  		  <tr>
  		...
  		<table width=100% height='<%=session("heightIs")%>px' border=0 cellpadding=0 cellspacing=0 > 
        	...
        	<td width=200 background="Images/tableback.png">
			  <table width=103% border=0 cellpadding=0 cellspacing=0 class=MenuStyleParent>
			    <tr height=20>
          		  <td width=11></td>
				...
				<tr height=20>
				  ...
				  <td align=Left bgcolor="#FFFFFF"><Div style="height:18px; border:Solid; border-width:1px; border-color:#438BE4; color: #003399;">New Op Task Category</Div></td>
				  <td align=Left  ></td>
				</tr>
			  </table>
			</td>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminOpTcList.asp">Back To List</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
					...
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=76% >
						 <INPUT name="description" id="description" class="itemfont" id="description" style="WIDTH: 360px" Value="" maxLength=300></td>
						<td valign="middle" width=2%></td>
					  </tr>
					  <tr height=16>
					    <td></td>
