      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
          <tr style="font-size:10pt;" height=26px>
                ...
                <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>New Vaccinations</strong></font></td>
          </tr>
  		  <tr>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminVaccinationsList.asp?recID=<%=request("recID")%>">Back To List</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><INPUT class="itemfont" style="WIDTH: 340px" maxLength=300 name=Description></td>
					  </tr>
					  <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><INPUT type="checkbox" name="chkCombat" value="1"></td>
					  </tr>					  
					  <tr height=16>
						<td></td>
					  </tr>
