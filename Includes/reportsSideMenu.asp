...
<table border="0" cellspacing="0" cellpadding="0"class="MenuStyleParent">
	<tr height="30">
		<td></td>
	...
	<% if session("Aut") <> 0 then %>
			...
			<tr height="30">
				...
				<% if location = "Reports" and subLocation="13" then %>
					<td align="left" class="selected">Individual Authorisations</td>
				<% else %>  
					<td align="left"><A title="" href="reportsCISIndividualAuth.asp">Individual Authorisations</A></td>
				<% end if %> 
				<td align="left"></td>
			</tr>
    <% end if %>
