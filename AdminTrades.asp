		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
    	  <tr >
      	    <td align="center" class="sidemenuwidth" ><img alt="" src="images/spssites.gif" ></td>
       		<td  class=titlearea >Trades<BR>
       		<span class="style1"><Font class=subheading>Trades</Font></span></td>
    	  </tr>
  		  <tr>
  		...
  		<table width=100% height='<%=session("heightIs")%>px' border=0 cellpadding=0 cellspacing=0 > 
            ...
            <td class="sidemenuwidth" background="Images/tableback.png">
			  <!--#include file="Includes/TradesMenu.inc"-->
			</td>
			<td width=16></td>
		    <td align=left >
				...
				<tr height=16 class=SectionHeader>
				  <td>
				     <table border=0 cellpadding=0 cellspacing=0 width=100%>
							<tr height=16 class=SectionHeader>
                              <td width="1%">&nbsp;</td>
							  <td width="99%" class=toolbar>Trades</td>
							</tr>
					</table>
				    <table border=0 cellpadding=0 cellspacing=0 width=100% class=MenuStyleParent>
					  ...
					  <tr height=16>
				        ...
				        <td class=toolbar width="20%"><A title="vnavicon" href="AdminTradeGroupList.asp">Trade Groups </a></td>
					    <td class=toolbar width="20%"><A title="" href="AdminTradeList.asp">Trade List</a></td>
