          ...
          <!--#include file="Includes/Header.inc"--> 
    	    ...
    	    <tr >
      		  <td align="center" class="sidemenuwidth" ><img alt="" src="images/spssites.gif" ></td>
       		  <td  class=titlearea >TCW CMS<BR><span class="style1"><Font class=subheading>Military Vaccinations</Font></span></td>
    		</tr>
  			<tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td class=toolbar valign="middle" >New Military Vaccination</td>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=20>
							  ...
							  <td valign="middle" width=15%>Description</td></td>
							  <td width=3%></td>
							  <td valign="middle" width=36%>Required</td>
							  <td valign="middle"  width=6%>Valid Period</td>
							...
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("MSWID")%>" height=20>
								<td valign="middle" width=2%></td>
								<td valign="middle" align="center"><A class=itemfontlink href="AdminVaccinationDetail.asp?RecID=<%=rsRecSet("MSWID")%>"><%=rsRecSet("Description")%></A></td>
								<td ></td>
								<td valign="middle"><%if rsRecSet("MVRequired") = 1 then response.write "YES" else response.write "NO" end if%></td>
								<td valign="middle" align="center"><%=rsRecSet("ValidPeriod")%></td>
