...
strPage="WtQ"
strTable = "tblQWeight"
strGoTo = "AdminQWtList.asp"   ' asp page to return to once record is deleted
strTabID = "qwID"              ' key field name for table        
      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Qualification Weight Details</strong></font></td>
                    </tr>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
					    ...
					    <td class=toolbar valign="middle" >New Q Weight</td>
						<td class=titleseparator valign="middle" width=14 align="center">|</td>
                        -->
						<td class=toolbar width=8></td><td width=20><a class=itemfontlink href="AdminQWtEdit.asp?RecID=<%=request("RecID")%>"><img class="imagelink" src="images/editgrid.gif"></A></td>
						<td class=toolbar valign="middle" >Edit Q Weight</td>
						<td class=titleseparator valign="middle" width=14 align="center">|</td>
						...
						<td class=toolbar valign="middle" >Delete Q Weight</td>

						<td class=titleseparator valign="middle" width=14 align="center">|</td>
						<td class=toolbar valign="middle" ><A class=itemfontlink href="AdminQWtList.asp">Back To List</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
					    ...
					    <td valign="middle" width="13%">Weight Type:</td>
						<td valign="middle" width=85% class=itemfont><%=rsRecSet("qwType")%></td>
					  </tr>
					  <tr class=columnheading height=22>
					    <td valign="middle" width=2%>&nbsp;</td>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><%=rsRecSet("qwValue")%></td>
					  </tr>
					  <tr height=16>
						<td></td>
					  </tr>
