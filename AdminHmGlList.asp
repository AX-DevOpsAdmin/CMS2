          ...
          <!--#include file="Includes/Header.inc"--> 
  		 <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Harmony</strong></font></td>
                    </tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td class=toolbar valign="middle" >New Harmony Guidelines</td>
							</tr>  
					      </table>
						</td>
					  </tr>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=30>
							  ...
							  <td valign="middle" width=27%>Harmony Override Reason </td>
							...
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("hmovID")%>" height=30>
								<td valign="middle" width=2%></td>
				                <td valign="middle"><A class=itemfontlink href="javascript: subForm(<%=rsRecSet("hmovID")%>)"><%=rsRecSet("Description")%></A></td> 
								<td valign="middle" width=49%></td>
						      </tr>
  							  <tr>
       						    <td colspan=5 class=titlearealine  height=1></td> 
...
function subForm(recID){
     document.forms.frmDetails.action = "AdminHmGlDetail.asp";
