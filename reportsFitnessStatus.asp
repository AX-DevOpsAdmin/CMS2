...
%>
	<script language="JScript">
		...
		window.location = "reportsFitnessStatus.asp?myHeight1="+myHeight;
	</script>
<%
else
   'session.timeout = 60
...
function launchReportWindow()
{
	...
	document.frmDetails.action="reportsFitnessStatusSubmit.asp";
...
function launchReportWindowExcel()
{
	...
	document.frmDetails.action="reportsFitnessStatusExcel.asp";
