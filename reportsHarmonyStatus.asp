...
%>
	<script language="JScript">
		...
		window.location = "reportsHarmonyStatus.asp?myHeight1="+myHeight;
	</script>
<%
else
   'session.timeout = 60
			...
			<td> 
				...
				<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        <td width=10px>&nbsp;</td>
                        <td><a title="" href="index.asp" class=itemfontlinksmall>Home</a> > <A href='reportsHome.asp' class=itemfontlinksmall >Reports</A> > <font class='youAreHere' >Personnel Harmony</font></td>
                    </tr>
                    <tr>
                ...
                <table width=100% height='<%=session("heightIs")%>px' border=0 cellpadding=0 cellspacing=0 > 
                    <tr valign=Top>
                        ...
                        <td width=16></td>
                        <td align=left>
                            <form action="reportsPersHarmonySubmit.asp" method="POST" name="frmDetails" target="Report">
                                     ...
                                     <td align=left valign=top>
                                        <table border=0 cellpadding=0 cellspacing=0 width=615>
                                            ...
                                            <tr>
                                             ...
                                             <td width="110" class="subheading">Sub Unit(s):</td>
                                             <td width="65"><input name="chkSub" type="checkbox" id="chkSub" value="1"></td>
                                             <td width="65" align=left class="subheading">Gender:</td>
                                             <td width="65">					
                                                <select name="cboGender" id="cboGender" style="width:70px; font-size:8pt" >
...
function launchReportWindow()
{
	...
	document.frmDetails.action="reportsProcessHarmonySubmit.asp";
...
function launchReportWindowExcel()
{
	...
	document.frmDetails.action="reportsProcessHarmonyExcel.asp";
