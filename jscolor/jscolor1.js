...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			// pad image
			switch(modeID) {
				case 0: var img = 'images/hs.png'; break
				case 1: var img = 'images/hv.png'; break
			}
			...
			p.padM.style.background = "url('"+jscolor.getDir()+"images/jscross.gif') no-repeat"
			...
			p.sldM.style.background = "url('"+jscolor.getDir()+"images/jsarrow.gif') no-repeat"
			try {
