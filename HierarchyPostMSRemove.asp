...
<form action="RemovePostMS.asp" method="post" name="frmDetails">
    ...
    <input type="hidden" name="ReturnTo" id="ReturnTo" value="HierarchyPostMSRemove.asp"/>
			...
			<td>
				<table border=0 cellpadding=0 cellspacing=0 >
                	<tr>
						...
						<td height="25px" width="39" valign="middle" class=toolbar >Save</td>
						<td height="25px" class=titleseparator valign="middle" width=13 align="center">|</td>
						<td width="88" height="25px" valign="middle" class=toolbar ><A class=itemfontlink href="HierarchyPostMSDetails.asp?postID=<%=request("postID")%>">Back</A></td>											
					</tr>
				</table>
			</td>
		</tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
										<table border=0 cellpadding=0 cellspacing=0 width=100%>
                                            <tr class=" toolbar">
                                                <td height="25px" valign="middle">Military Skills Held</td>
                                                <td height="25px">&nbsp;</td>
                                                <td height="25px" valign="middle">Military Skills to Remove</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" height="22px">&nbsp;</td>
                                            </tr>
											<tr>
												...
												<select name="lstAttached" size="10" multiple class="pickbox" style="width:180px;" id="lstAttached" onChange="remAttached()"> 
													<% if not rsQualificationDetails.bof and not rsQualificationDetails.eof then %>
														<% do while not rsQualificationDetails.eof %>
															<option value=<%= rsQualificationDetails("PostMSid") %>><%= rsQualificationDetails("Description") %></option>
															<% rsQualificationDetails.movenext() %>
														<% loop %>
													<% end if %>
												</select>
                                                ...
                                                <td height="22px">&nbsp;</td>
                                                <td height="22px">
                                                	<select name="pickAttached" size="10" class="pickbox" id="pickAttached" style="width:180px;" onChange="addAttached()">
                                                	</select>
                                                </td>
											</tr>
										</table>
