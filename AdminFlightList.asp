...
objCmd.CommandText = "spListFlights"	'Name of Stored Procedure
...
<form  action="" method="POST" name="frmDetails">
  <Input name="FlightID" id="FlightID" type="Hidden">
        ...
        <td>
          ...
          <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Flights</strong></font></td>
                    </tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td width=20><a class=itemfontlink href="AdminFlightAdd.asp"><img class="imagelink" src="images/newitem.gif"></a></td>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=20>
							  ...
							  <td valign="middle" width=30%>Flight</td>
							  <td valign="middle" width=68%>Squadron</td>
							</tr>
						  	<tr>
       						  <td colspan=5 class=titlearealine  height=1></td> 
     					    </tr>
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("fltID")%>" height=30>
								<td valign="middle" width=2%>&nbsp;</td>
				                <td valign="middle" width="30%"><A class=itemfontlink href="javascript: subForm(<%=rsRecSet("fltID")%>)"><%=rsRecSet("Description")%></A></td> 
								<td valign="middle" width="68%"><%=rsRecSet("sqn")%></td>
						      </tr>
  							  <tr>
...
function subForm(recID){
     document.forms.frmDetails.action = "AdminFlightDetail.asp";
	 document.forms.frmDetails.FlightID.value = recID;
