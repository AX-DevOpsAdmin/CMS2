          ...
          <!--#include file="Includes/Header.inc"--> 
  		 <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Rank Weights</strong></font></td>
                    </tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td width=20><a class=itemfontlink href="AdminRankWtAdd.asp"><img class="imagelink" src="images/newitem.gif"></a></td>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=20>
							  ...
							  <td valign="middle" width=10%>Weight</td>
							  <td valign="middle" width=88%%>Description</td>
							</tr>
						  	<tr>
       						  <td colspan=3 class=titlearealine  height=1></td> 
     					    </tr>
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("rwID")%>" height=30>
								<td valign="middle" width=2%>&nbsp;</td>
				                <td valign="middle" width="13%"><A class=itemfontlink href="javascript: subForm(<%=rsRecSet("rwID")%>)"><%=rsRecSet("rankwt")%></A></td> 
...
function subForm(recID){
     document.forms.frmDetails.action = "AdminRankWtDetail.asp";
