...
if strAction = "Update" then
    strCommand = "spQTypeUpdate"
    strGoTo = "AdminQTypeDetail.asp?QTypeID=" & request("RecID")
elseif  strAction = "Add" then
    strCommand = "spQTypeInsert"
	strGoTo = "AdminQTypeAdd.asp"	
end if

if request("chkAuth") = 1 then
	intAuth = 1
else
	intAuth = 0
end if
...
objCmd.parameters.append objPara
set objPara = objCmd.createparameter("@Auth",11,1,1, intAuth)
objCmd.parameters.append objPara
