    ...
    UPDATE tbl_Task 
       SET description=REPLACE(description,'Z-DO NOT USE', '')
    ...
    **/
    ...
    -- External Exercise taskTypeID = 29
     -- taskID  5362 No Harmony
     -- taskID  5363 OOA
     -- taskID  4047 BNA
   DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=29 AND ooa=0 AND taskID <> 5362
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
	 ...
	 DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=29 AND ooa=1 AND taskID <> 5363
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=37 AND ooa=2 AND taskID <> 5365
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=21 AND ooa=2 AND taskID <> 5366
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=17 AND ooa=2 AND taskID <> 5367
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=16 AND ooa=1 AND taskID <> 5368
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=16 AND ooa=2 AND taskID <> 5369
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
    ...
    DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE (taskTypeID=12 OR taskTypeID=13 OR taskTypeID=15) AND ooa=0 AND taskID <> 5370
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE (taskTypeID=12 OR taskTypeID=13 OR taskTypeID=15) AND ooa=1 AND taskID <> 5371
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE (taskTypeID=12 OR taskTypeID=13 OR taskTypeID=15) AND ooa=2 AND taskID <> 5372
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
    ...
    -- Operations taskTypeID=1
      -- TaskID 5373  No Harmony
      -- TaskID 5374  OOA
      -- TaskID 5375  BNA
    DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=1 AND ooa=0 AND taskID <> 5373
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=1 AND ooa=1 AND taskID <> 5374
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
	...
	DECLARE fld1 CURSOR FOR SELECT taskID, taskTypeID, [description] FROM tbl_Task 
      WHERE taskTypeID=1 AND ooa=2 AND taskID <> 5375
		OPEN fld1
		FETCH NEXT FROM fld1 INTO @taskID, @taskTypeID, @name
