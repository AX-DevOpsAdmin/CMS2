...
<body>
<!-- <form  action="UpdateTask Category.asp?strAction=<%=strAction%>" method="POST" name="frmDetails"> -->
<form  action="UpdateOpTc.asp?strAction=<%=strAction%>&strTable=<%=strTable%>&strTabid=<%=strRecID%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"--> 
    	    ...
    	    <tr >
      		  <td align="center" width=200 ><img alt="" src="images/spssites.gif" ></td>
       		  ...
       		  <span class="style1"><Font class=subheading>Edit Op Task Category Details</Font></span></td>
    		</tr>
  			<tr>
        	  ...
        	  <td width=200 background="Images/tableback.png">
			    <table width=100% border=0 cellpadding=0 cellspacing=0 class=MenuStyleParent>
				  ...
				  <tr height=20>
				    ...
				    <td width="159" align=Left  ><A title="" href="index.asp">Home</A></td>
				  ...
				  <tr height=20>
	          		<td width=10></td>
				    <td valign=top><img src="images/arrow.gif"></td>
				    <td align=Left  ><A title="" href="AdminOpTcList.asp">Operational Tasks</a></td>
				    <td align=Left  ></td>
				  </tr>
				  <tr height=20>
	          	    <td width=10></td>
				    <td valign=top><img src="images/arrow.gif"></td>
                    <td align=Left  ><A title="" href="AdminOpTcDetail.asp?RecID=<%=request("RecID")%>">Op Task Category Details</a></td>
					<td class=rightmenuspace align=Left ></td>
				  </tr>
				  <tr height=20>
	          	    <td width=10></td>
				    <td valign=top><img src="images/vnavicon.gif"></td>
					<td align=Left bgcolor="#FFFFFF"><Div style="height:18px; border:Solid; border-width:1px; border-color:#438BE4; color: #003399;">Edit Op Task Category</Div></td>
				    <!--<td align=Left  ></td>-->
				  </tr>
				</table>
			  </td>
				  ...
				  <tr height=16 class=SectionHeader>
					<td>
					  <table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminOpTcDetail.asp?RecID=<%=request("RecID")%>">Back</A></td>											
					 </table>
					</td>
			      </tr>
				  <tr>
					<td>
					  <table width=100% border=0 cellpadding=0 cellspacing=0>
						...
						<tr class=columnheading height=22>
						  ...
						  <td valign="middle" width=15%>Task Category:</td>
						  <td valign="middle" width=76%>
						    <INPUT class="itemfont" style="WIDTH: 360px" maxLength="300" name="description" id="description" Value="<%=rsRecSet("Description")%>"></td>
						  <td valign="middle" width=2%></td>
						</tr>
						<tr height=16>
						  <td></td>
...
function checkThis(){
    ...
    if(!txt.length > 0) {
	   errMsg += "You must enter a Task Category\n"
