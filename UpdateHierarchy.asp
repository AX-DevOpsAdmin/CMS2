...
if strAction = "Update" then
	strCommand = "spHierarchyUpdate"
	strGoTo = "AdminHierarchyList.asp"
elseif  strAction = "Add" then
	strCommand = "spHierarchyInsert"
	strGoTo = "AdminHierarchyAdd.asp"
end if
...
set objPara = objCmd.CreateParameter ("parentID",3,1,0, request("cmbhrc"))
objCmd.Parameters.Append objPara
