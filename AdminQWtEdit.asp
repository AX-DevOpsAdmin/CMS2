...
<body>
<form  action="UpdateQWeight.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"--> 
  		  <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Qualification Weight</strong></font></td>
                    </tr>
				  ...
				  <tr height=16 class=SectionHeader>
					<td>
					  <table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminQWtDetail.asp?RecID=<%=request("RecID")%>">Back</A></td>											
					 </table>
					</td>
			      </tr>
				  <tr>
					<td>
					  <table width=100% border=0 cellpadding=0 cellspacing=0>
						...
						<tr class=columnheading height=22>
						   ...
						   <td valign="middle" width="85%"><input type="text" class="numberbox" name="txtType" id="txtType" width="3" Value="<%=rsRecSet("qwType")%>"></td>
					    </tr>
						<tr class=columnheading height=22>
						  <td valign="middle" width=2%>&nbsp;</td>
					    ...
					    <tr class=columnheading height=22>
						   ...
						   <td valign="middle" width="85%"><input type="text" class="numberbox" name="txtWt" id="txtWt" width="3" Value="<%=rsRecSet("qwValue")%>"></td>
					    </tr>
						<tr height=16>
						  <td></td>
						</tr>
...
function checkThis()
{
	...
	var wtype = document.frmDetails.txtType.value;  
	wtype = wtype.killWhiteSpace();
	var d = document.frmDetails.description.value;
	d = d.killWhiteSpace();
	var wt = document.frmDetails.txtWt.value; 
	var re = /[a-z,A-Z\^,£<>$":;{}\[\]\*\.+\-_=~#@?\\\/%\'!¬`¦&]/g;
