...
if request("doSearch") = 1 then
	...
	objCmd.Parameters.Append objPara
	set objPara = objCmd.CreateParameter ("Active",3,1,0, strActive)
	objCmd.Parameters.Append objPara
...
<body>
<form action="AdminPeRsAuthList.asp" method="post" name="frmDetails">
        	...
        	<td>
          	<!--#include file="Includes/Header.inc"--> 
                    ...
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Personnel</strong></font></td>
                    </tr>
					    			...
					    			<td>
						  				<table width="164" border=0 cellpadding=0 cellspacing=0 >
						    				<tr> 
                                                ...
                                                <td width=25><a class=itemfontlink href="javascript:CheckForm();"><img class="imagelink" src="images/icongo01.gif"></a></td>
                                                <td width=41 align="center" class=toolbar>Find</td>
                                                <td width=13 align="center" class=titleseparator>|</td>
                                                <td width=25 align="center"><a class=itemfontlink href="javascript:Reset();"><img class="imagelink" src="Images/reset.gif"></a></td>
                                                <td width=48 class=toolbar align="center">Reset</td>
											</tr>  
					      				</table>
									</td>
					  			</tr>
									...
									<td>
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr class="searchheading" height="30">
                                                ...
                                                <td valign="middle" width="6%">Surname:</td>
                                                <td valign="middle" width="11%"><input class="itemfont" style="width:150px" maxLength="20" name="surname" id="surname" value="<%=replace(request("surname"),"''","'")%>" onchange="javascript:newSearch();"></td>
                                                <td valign="middle" width="1%"></td>
                                                <td valign="middle" width="5%">First Name</td>
                                                <td valign="middle" width="75%"><input class="itemfont" style="width:150px" maxLength="20" name="firstname" id="firstname" value="<%=replace(request("firstname"),"''","'")%>"></td>
                                            </tr>
                                            <tr class="searchheading" height="22">
                                                <td valign="middle" width="2%">&nbsp;</td>
                                                <td valign="middle" width="6%">Service No:</td>
                                                <td valign="middle" width="11%"><input class="itemfont" style="width:150px" maxLength="20" name="serviceno" id="serviceno" value="<%=replace(request("serviceno"),"''","'")%>"></td>
                                                <td valign="middle" width="1%"></td>
                                                <td valign="middle" width="5%">Rank:</td>
					    			...
					    			<td>
						  				<table width=100% border=0 cellpadding=0 cellspacing=0>
											...
											<tr class=itemfont ID="TableRow<%=rsRecSet ("staffID")%>" height=30 <%if counter=0 then%>style="background-color:<%=color1%>;"<%else%>style="background-color:<%=color2%>;"<%end if%>>
												<td valign="middle" width=2%>&nbsp;</td>
												<td valign="middle" width="13%"><A class=itemfontlink href="AdminPeRsAuthorise.asp?staffID=<%=rsRecSet("staffID")%>"><%=rsRecSet("serviceno")%></A></td>
