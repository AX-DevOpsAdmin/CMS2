...
'response.write request("lvl")

strTable = "tblstaff"
 strGoTo = "AdminPeRsAuths.asp"   ' asp page to return to once record is deleted'
'if request("lvl")=2 then
'  strGoTo = "AdminPeRsAssessor.asp"   ' asp page to return to once record is deleted'
'else
...
<body>
    <form action="AdminRemoveAuths.asp" method="post" name="frmDetails">
        ...
        <input type="hidden" name="ReturnTo" value=<%=strGoTo%>>
                                        ...
                                        <td>
                                            <table border=0 cellpadding=0 cellspacing=0 >
                                                <tr>
                                                    ...
                                                    <td height="25px" class=toolbar valign="middle"><A class=itemfontlink href="<%=strGoTo%>?staffID=<%=request("staffID")%>&atpID=<%=cint(request("atpID"))%>">Back</A></td>											
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td>
                                                                    <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                                                        <tr class="SectionHeader toolbar">
                                                                            <td height="25px" align="left">Authorisations Held</td>
                                                                            <td height="25px">&nbsp;</td>
                                                                            <td height="25px" align="left">Authorisations to Remove</td>
                                                                        </tr>
                                                                        <tr>
                                                                             ...
                                                                             <%end if%>
                                                                                <select name="lstAttached" size="10" multiple class="pickbox" style="width:180px;" id="lstAttached" onChange="remAttached()"> 
                                                                                    <% if not rsRecSet.bof and not rsRecSet.eof then %>
                                                                                        <% do while not rsRecSet.eof %>
                                                                                            <option value=<%= rsRecSet("asrID")%>><%= rsRecSet("authCode") %></option>
                                                                                            <% rsRecSet.Movenext() %>
                                                                                        <% loop %>
                                                                                    <% end if %>
                                                                                </select>
