...
objCmd.CommandText = "spPostMSAvailable"	'Name of Stored Procedure
...
<form action="AddPostMS.asp" method="get" name="frmDetails">
    ...
    <input type="hidden" name="ReturnTo" id="ReturnTo" value="HierarchyPostMSAdd.asp"/>
			...
			<td>
				<table border=0 cellpadding=0 cellspacing=0>
                	<tr>
						...
						<td height="25px" width=22><a id=SaveCloseLink href="javascript:saveNew();"><img class="imagelink" src="images/saveitem.gif"></A></td>
						<td height="25px" width="56" valign="middle" class=toolbar>Save</td>
						<td height="25px" class=titleseparator valign="middle" width=11 align="center">|</td>
						<td width="73" height="25px" valign="middle" class=toolbar ><A class=itemfontlink href="HierarchyPostMSDetails.asp?postID=<%=request("postID")%>">Back</A></td>											
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				...
				<table border=0 cellpadding=0 cellspacing=0 width=100%>
					...
					<tr class=SectionHeader>
						...
						<td width="50%" height="22px" valign="top">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            	<tr>
                                	<td>
                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
											<tr class="SectionHeader toolbar">
												<td height="25px" valign="middle">Military Skills Available</td>
                                                <td height="25px">&nbsp;</td>
												<td height="25px" valign="middle">Military Skills to Add</td>
											</tr>
                                            <tr>
                                                <td colspan="3" height="22px">&nbsp;</td>
                                            </tr>
												...
												<td class="ColorBackground">
													...
													<% if not rsQAvailableList.bof and not rsQAvailableList.eof then %>
														<% do while not rsQAvailableList.eof %>
															<option value=<%= rsQAvailableList("MSid") %>><%= rsQAvailableList("Description") %></option>
...
<form name="frmPopUpForm">
	<div id="PopUpwindow1" class="PopUpWindow">
		<table border=0 cellpadding=0 cellspacing=0 width=100%>
			...
			<tr class=columnheading>
				<td colspan=3 height=22 align="center"><Input CLASS="StandardButton" Type=Button style="width:60px;" Value=OK onclick="javascript:populateArrays();"></td>
			</tr>
            <tr>
                <td colspan="3" height="22px">&nbsp;</td>
            </tr>
