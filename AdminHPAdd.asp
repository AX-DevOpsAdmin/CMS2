...
<form  action="UpdateHP.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
  <input type="hidden" id="Harmony PeriodID" name="Harmony PeriodID" value="<%=request("Harmony PeriodID")%>">  
                ...
                <!--#include file="Includes/Header.inc"-->
  				<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Add New Harmony Period</strong></font></td>
                    </tr>
									...
									<td width="98%">
                                        <table width=770px border=0 cellpadding=0 cellspacing=0>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td colspan="2" valign="middle"><INPUT name="ooaper" id="ooaper" class="itemfont" size="3" maxLength=3></td>
                                            </tr>
                                            <tr class=columnheading height=22>
                                                <td width="4px" valign="middle"></td>
                                                <td width="150px" valign="middle">Red Days:</td>
                                                <td width="40px" valign="middle"><INPUT name="ooared" id="ooared" class="itemfont" size="3" maxLength=3></td>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td valign="middle"><INPUT name="ooaamber" id="ooaamber" class="itemfont" size="3" maxLength=3></td>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td colspan="2" valign="middle"><INPUT name="ssaper" id="ssaper" class="itemfont" size="3" maxLength="3"></td>
                                            </tr>
                                            <tr class=columnheading height=22>
                                                <td valign="middle"></td>
                                                <td valign="middle">Red Days:</td>
                                                <td valign="middle"><INPUT name="ssared" id="ssared" class="itemfont" size="3" maxLength="3"></td>
                                            ...
                                            <tr class=columnheading height=22>
                                                <td valign="middle"></td>
                                                <td valign="middle">Amber Days:</td>
                                                <td valign="middle"><INPUT name="ssaamber" id="ssaamber" class="itemfont" size="3" maxLength="3" ></td>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td colspan="2" valign="middle"><INPUT name="ssbper" id="ssbper" class="itemfont" size="3" maxLength="3"></td>
                                            </tr>
                                            <tr class=columnheading height=22>
                                                <td valign="middle"></td>
                                                <td valign="middle">Red Days:</td>
                                                <td valign="middle"><INPUT name="ssbred" id="ssbred" class="itemfont" size="3" maxLength="3"></td>
                                            ...
                                            <tr class=columnheading height=22>
                                                <td valign="middle"></td>
                                                <td valign="middle">Amber Days:</td>
                                                <td valign="middle"><INPUT name="ssbamber" id="ssbamber" class="itemfont" size="3" maxLength="3"></td>
