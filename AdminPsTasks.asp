      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
    	  <tr >
              ...
              <span class="style1"><Font class=subheading> Task Details</Font></span></td>
    	  </tr>
  		  <tr>
  		...
  		<table width=100% height='<%=session("heightIs")%>px' border=0 cellpadding=0 cellspacing=0 > 
      	  <tr valign=Top>
            <td class="sidemenuwidth" background="Images/tableback.png"><!--#include file="Includes/PtMenu.inc"--></td>
			<td width=16></td>
		    <td align=left >
				...
				<tr height=16 class=SectionHeader>
				  <td>
				    <table border=0 cellpadding=0 cellspacing=0 width=100%>
					  <tr height=16 class=SectionHeader>
                      	<td width="1%">&nbsp;</td>
						<td width="99%" class=toolbar>Tasks</td>
					  </tr>
				    </table>
					 <table border=0 cellpadding=0 cellspacing=0 width=100% class=MenuStyleParent>
					  ...
					  <tr height=16>
				        ...
				        <td class=toolbar width="15%"><A title="" href="AdminPsTyList.asp">Task Types </a></td>
					    <td class=toolbar width="15%"><A title="" href="AdminPsTaList.asp">Tasks </a></td>
					    <td class=toolbar width="68%">&nbsp;</td>
					  </tr>
