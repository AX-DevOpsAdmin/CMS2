    		...
    		<td>
    			<!--#include file="Includes/Header.inc"--> 
                    ...
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Authorisation Type</strong></font></td>
                    </tr>
                                    ...
                                    <td>
                                        <table width=100% border=0 cellpadding=0 cellspacing=0>
                                            ...
                                            <tr class=columnheading height=22>
                                                ...
                                                <td valign="middle" width=85%><input class="itemfont" style="width: 360px" maxLength=300 name="txtDescription" id="txtDescription" value="<%= rsRecSet("authType") %>"></td>
                                            </tr>
                                            <tr height=16>
                                                <td colspan="3">&nbsp;</td>
                                            </tr>
