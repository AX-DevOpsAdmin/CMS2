        ...
        <!--#include file="Includes/Header.inc"--> 
  		 <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Out Of Area</strong></font></td>
                    </tr>
				  ...
				  <tr height=16 class=SectionHeader>
					<td>
					  <table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle"><A class= itemfontlink href="AdminOoAdDetail.asp?RecID=<%=request("RecID")%>">Back</A></td>											
					 </table>
					</td>
			      </tr>
				  <tr>
					<td>
					  <table width=100% border=0 cellpadding=0 cellspacing=0>
						...
						<tr class=columnheading height=22>
						  ...
						  <td valign="middle" width=13%>Maximum OOA Days </td>
						  <td valign="middle" align="left" width=85%><input class="itemfont" style="WIDTH: 30px" maxLength="300" name="ooadays" id="ooadays" Value="<%=rsRecSet("ooamaxdays")%>"></td>
						</tr>
						<tr class=columnheading height=22>
						  <td valign="middle" width=2%></td>
						  <td valign="middle" width=13%>Amber Days</td>
                          <td valign="middle" align="left" width=85%><input class="itemfont" style="WIDTH: 30px" maxlength="300" name="ambdays" name="ambdays" value="<%=rsRecSet("amberdays")%>"></td>
						</tr>
						<tr height=16>
						  <td colspan="3"></td>
						</tr>
...
//    if(parseint(amb, 10) >= parseint(oad, 10) ) //&& oad.length > 0)
	if( Number(amb) >= Number(oad) )
	{
		 //alert("Days are " + oad + " * " + amb + " * " + oad.length);
