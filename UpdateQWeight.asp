...
IF strAction = "Update" THEN
    strCommand = "spQWeightUpdate"
    strGoTo = "AdminQWtDetail.asp?RecID=" & request("RecID")
ELSEIF  strAction = "Add" THEN
    strCommand = "spQWeightInsert"
	strGoTo = "AdminQWtAdd.asp"
ELSE
	
END IF  
'response.write strAction & " * " & strCommand & " * " & strGoTo & request("RecID")
'response.End()
...
set objPara = objCmd.CreateParameter ("QWtType",200,1,5, request("txtType"))
objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter ("Description",200,1,100, request("Description"))
objCmd.Parameters.Append objPara
set objPara = objCmd.CreateParameter ("QWeight",3,1,0, cInt(request("txtWt")))
objCmd.Parameters.Append objPara
