									...
									<td>
										<table width=100% border=0 cellpadding=0 cellspacing=0>
                                          <!--
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("man") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("per") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("uni") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                            ...
                                            <!--
                                            <tr class=itemfont ID="cap" height="30">
                                                <td width=2%>&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center"><%' if rsRecSet("cap") = true then %><img src="Images/yes.gif" alt="active"><% 'else %><img src="Images/no.gif" alt="disabled"><% 'end if %></td>
                                                            <td width="30">&nbsp;</td>
															<td align="center"><%' if rsRecSet("cap") = true then %><img src="Images/no.gif" alt="disabled"><%' else %><img src="Images/yes.gif" alt="active"><%' end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                            ...
                                            <tr class=itemfont ID="pre" height="30">
                                                <td width=2%>&nbsp;</td>
                                                <td align="left" width="30%">Present/Absent:</td> 
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center"><% if rsRecSet("pre") = true then %><img src="Images/yes.gif" alt="active"><% else %><img src="Images/no.gif" alt="disabled"><% end if %></td>
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("pre") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<!--<td align="center"><% 'if rsRecSet("fit") = true then %><img src="Images/no.gif" alt="disabled"><%' else %><img src="Images/yes.gif" alt="active"><%' end if %></td>-->
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("boa") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                            ...
                                            <!--
                                            <tr class=itemfont ID="sch" height="30">
                                                <td width=2%>&nbsp;</td>
                                                <td align="left" width="30%">Tasking Schedule:</td> 
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center"><% 'if rsRecSet("sch") = true then %><img src="Images/yes.gif" alt="active"><%' else %><img src="Images/no.gif" alt="disabled"><%' end if %></td>
                                                            <td width="30">&nbsp;</td>
															<td align="center"><%' if rsRecSet("sch") = true then %><img src="Images/no.gif" alt="disabled"><%' else %><img src="Images/yes.gif" alt="active"><% 'end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                            ...
                                            <tr class=itemfont ID="nom" height="30">
                                                <td width=2%>&nbsp;</td>
                                                <td align="left" width="30%">Nominal Role:</td> 
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center"><%' if rsRecSet("nom") = true then %><img src="Images/yes.gif" alt="active"><% 'else %><img src="Images/no.gif" alt="disabled"><%' end if %></td>
                                                            <td width="30">&nbsp;</td>
															<td align="center"><%' if rsRecSet("nom") = true then %><img src="Images/no.gif" alt="disabled"><%' else %><img src="Images/yes.gif" alt="active"><%' end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("ran") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                            ...
                                            <!--
                                            <tr class=itemfont ID="pos" height="30">
                                                <td width=2%>&nbsp;</td>
                                                <td align="left" width="30%">Personnel by Post:</td> 
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
															<td align="center"><%' if rsRecSet("pos") = true then %><img src="Images/yes.gif" alt="active"><%' else %><img src="Images/no.gif" alt="disabled"><% 'end if %></td>
                                                            <td width="30">&nbsp;</td>
															<td align="center"><%' if rsRecSet("pos") = true then %><img src="Images/no.gif" alt="disabled"><%' else %><img src="Images/yes.gif" alt="active"><%' end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("aut") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("ind") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("rod") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
                                                ...
                                                <td align="center" width="10%">
													<table width="100px" border="0" cellpadding="0" cellspacing="0">
														<tr>
                                                            ...
                                                            <td width="30">&nbsp;</td>
															<td align="center"><% if rsRecSet("paq") = true then %><img src="Images/no.gif" alt="disabled"><% else %><img src="Images/yes.gif" alt="active"><% end if %></td>
														</tr>
													</table>
                                                </td> 
                                                <td width="58%">&nbsp;</td>
