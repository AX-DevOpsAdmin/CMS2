...
<body>
<form action="UpdateVaccination.asp?strAction=<%=strAction%>" method="post" name="frmDetails">
      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
          <tr style="font-size:10pt;" height=26px>
                ...
                <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Vaccination Details</strong></font></td>
          </tr>
  		  <tr>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminVaccinationDetail.asp?recID=<%=request("recID")%>">Back</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><INPUT class="itemfont" style="WIDTH: 340px" maxLength=300 name=Description Value="<%=rsRecSet("Description")%>"></td>
					  </tr>
					  <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
						<td valign="middle" width="13%">Required:</td>
						<td valign="middle" width="85%" class=itemfont>
						<Select  class="inputbox" Name=MVRequired>
						<option value=1 <%if rsRecSet("MVRequired")=1 then response.write (" Selected")%>>Yes</option>
						<option value=0 <%if rsRecSet("MVRequired")=0 then response.write (" Selected")%>>No</option>
						</Select>
						</td>
					  </tr>
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width="85%" class=itemfont >
						<Select  class="inputbox" Name=VPID style="width:80px;">
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><INPUT type="checkbox" name="chkCombat" value="1" <% if rsRecSet("Combat") = true then %>checked<% end if %>></td>
					  </tr>					  
					  <tr height=16>
						<td></td>
					  </tr>
