...
<body>
<form action="AdminPeRsList.asp" method="post" name="frmDetails">
					  			...
					  			<tr height=16 class=SectionHeader>
					    			<td>
						  				<table width="314" border=0 cellpadding=0 cellspacing=0 >
						    				<tr> 
                                                <td width=7 class=toolbar></td>											   
                                                <td width=19><a class=itemfontlink href="AdminPeRsAdd.asp"><img class="imagelink" src="images/newitem.gif"></a></td>
                                                <td width=103 align="center" class=toolbar>New Personnel</td>
                                                ...
                                                <td width=36 align="center" class=toolbar>Find</td>
                                                <td width=12 align="center" class=titleseparator>|</td>
                                                <td width=24 align="center"><a class=itemfontlink href="javascript:Reset();"><img class="imagelink" src="Images/reset.gif"></a></td>
                                                <td width=77 class=toolbar align="center">Reset</td>
											</tr>  
					      				</table>
									</td>
					  			</tr>
									...
									<td>
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr class="searchheading" height="22">
                                                ...
                                                <td valign="middle" width="2%"></td>
                                                <td valign="middle" width="11%">Active</td>
                                                <td valign="middle" width="56%"><input name="chkActive" id="chkActive" type="checkbox" <% if strActive = 1 then  %> checked <% end if %>></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">&nbsp;</td>
                                            </tr>
					    			...
					    			<td>
						  				<table width=100% border=0 cellpadding=0 cellspacing=0>
											...
											<tr class=itemfont ID="TableRow<%=rsRecSet ("staffID")%>" height=30 <%if counter=0 then%>style="background-color:<%=color1%>;"<%else%>style="background-color:<%=color2%>;"<%end if%>>
												<td valign="middle" width=2%>&nbsp;</td>
												<td valign="middle" width="13%"><A class=itemfontlink href="AdminPeRsDetail.asp?staffID=<%=rsRecSet("staffID")%>"><%=rsRecSet("serviceno")%></A></td>
