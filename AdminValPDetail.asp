...
strGoTo = "AdminValPList.asp"   ' asp page to return to once record is deleted
strTabID = "vpID"              ' key field name for table        
...
if rsRecSet("vpType")= 1 then 
 strPeriod = "Days" 
elseif rsRecSet("vpType")= 2 then 
 strPeriod = "Weeks" 
elseif rsRecSet("vpType")= 3 then
  strPeriod = "Months" 
end if
               ...
               <!--#include file="Includes/Header.inc"-->
				<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Validity Details</strong></font></td>
                    </tr>
								...
								<tr height=16 class=SectionHeader>
									<td>
										<table border=0 cellpadding=0 cellspacing=0 >
                                            <!--
                                            <td width=20><a class=itemfontlink href="AdminValPAdd.asp"><img class="imagelink" src="images/newitem.gif"></a></td>
											<td valign="middle" class=toolbar >New Validity Period</td>
											<td class=titleseparator valign="middle" width=14 align="center">|</td>
                                            -->
                                            </td><td width=20><a class=itemfontlink href="AdminValPEdit.asp?RecID=<%=request("RecID")%>"><img class="imagelink" src="images/editgrid.gif"></A></td>
											<td valign="middle" class=toolbar >Edit Validity Period</td>
											<% if strDelOK = "0" then %>
                                                <td class=titleseparator valign="middle" width=14 align="center">|</td>
                                                ...
                                                <td class=toolbar valign="middle" >Delete Validity Period</td>
                                            <% end if %>
											<td class=titleseparator valign="middle" width=14 align="center">|</td>
											<td  valign="middle" class=toolbar ><A class=itemfontlink href="AdminValPList.asp">Back To List</A></td>											
									  </table>
									</td>
									...
									<td>
										<table width=100% border=0 cellpadding=0 cellspacing=0>
											...
											<tr class=columnheading height=22>
												...
												<td valign="middle" width="85%" class=itemfont><%=rsRecSet("vpLength")%></td>
											</tr>
											<tr class=columnheading height=22>
												<td valign="middle" width="2%">&nbsp;</td>
												<td valign="middle" width="13%">Period Type:</td>
												<td valign="middle" width="85%" class=itemfont><%=strPeriod%></td>
											</tr>
											<tr class=columnheading height=22>
												<td valign="middle" width="2%">&nbsp;</td>
											...
											<tr class=columnheading height=22>
												<td valign="middle" width="2%">&nbsp;</td>
												<td valign="middle" width="13%">Number of Days:</td>
												<td valign="middle" width="85%" class=itemfont><%=rsRecSet("vpdays")%></td>
											</tr>
											<tr height=16>
												<td></td>
											</tr>
