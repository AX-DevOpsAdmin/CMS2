					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td width=20><a class=itemfontlink href="AdminGroupAdd.asp"><img class="imagelink" src="images/newitem.gif"></a></td>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading>
							  ...
							  <td valign="middle" width=99% height=30>Group</td>
							</tr>
						  	<tr>
       						  <td colspan=2 class=titlearealine  height=1></td> 
     					    </tr>
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("grpID")%>" height=30>
								<td valign="middle" width=2%>&nbsp;</td>
				                <td valign="middle" width="98%"><A class=itemfontlink href="javascript: subForm(<%=rsRecSet("grpID")%>)"><%=rsRecSet("Description")%></A></td> 
						      </tr>
  							  <tr>
       						    <td colspan=2 class=titlearealine  height=1></td> 
     						  </tr>
