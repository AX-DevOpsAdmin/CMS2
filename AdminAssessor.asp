...
<body>
<form action="AdminAssessor.asp" method="post" name="frmDetails">
					    			...
					    			<td>
						  				<table width=100% border=0 cellpadding=0 cellspacing=0>
											...
											<tr class=itemfont ID="TableRow<%=rsRecSet ("staffID")%>" height=30 <%if counter=0 then%>style="background-color:<%=color1%>;"<%else%>style="background-color:<%=color2%>;"<%end if%>>
												<td valign="middle" width=2%>&nbsp;</td>
												<td valign="middle" width="13%"><A class=itemfontlink href="AdminPeRsAssessSelect.asp?staffID=<%=rsRecSet("staffID")%>"><%=rsRecSet("serviceno")%></A></td>
