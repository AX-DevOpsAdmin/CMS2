			...
			<td> 
				...
				<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        <td width=10px>&nbsp;</td>
                        <td><a title="" href="index.asp" class=itemfontlinksmall>Home</a> > <A href='reportsHome.asp' class=itemfontlinksmall >Reports</A> > <font class='youAreHere'>CAE 4000 - MAP-01</font></td>
                    </tr>
                    <tr>
...
function launchReportWindow()
{
	...
	document.frmDetails.action="reportsAuth4820BSubmit_new2.asp";
