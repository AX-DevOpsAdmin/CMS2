...
' This is the Initial Display Page of Cycle table data
          ...
          <!--#include file="Includes/Header.inc"--> 
  		 	<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Admin Cyle List</strong></font></td>
                    </tr>
					    ...
					    <td>
						  <table border=0 cellpadding=0 cellspacing=0 >
						    <tr>
							  ...
							  <td class=toolbar valign="middle">New Cycle</td>
							</tr>  
					      </table>
						</td>
					  </tr>
					    ...
					    <td>
						  <table width=100% border=0 cellpadding=0 cellspacing=0>
						    <tr class=columnheading height=20>
							  ...
							  <td valign="middle" width=20%>Cycle</td>
							  <td valign="middle" width=20%>Cycle Days</td>
							...
							<%do while not rsRecSet.eof%>
							  <tr class=itemfont ID="TableRow<%=rsRecSet ("CyID")%>" height=30>
								<td valign="middle" width=3%></td>
				                <td valign="middle"><A class=itemfontlink href="javascript: subForm(<%=rsRecSet("CyID")%>)"><%=rsRecSet("Description")%></A></td> 

								<td valign="middle" width=12%><%=rsRecSet("cydays")%></td>
							  </tr>
  							  <tr>
       						    <td colspan=5 class=titlearealine  height=1></td> 
     						  </tr>
...
function subForm(recID){
     document.forms.frmDetails.action = "AdminCycleDetail.asp";
