...
IF strAction = "Update" THEN
    strCommand = "spTradeUpdate"
    strGoTo = "AdminTradeDetail.asp?tradeid=" & request("tradeid")
ELSEIF  strAction = "Add" THEN
    strCommand = "spTradeInsert"
	strGoTo = "AdminTradeAdd.asp"
ELSE
...
set objPara = objCmd.CreateParameter ("TrGroupID",3,1,0, request("cmbtrgroup"))
objCmd.Parameters.Append objPara
