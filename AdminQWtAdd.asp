...
<form  action="UpdateQWeight.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
  <input type="hidden" name="QWeightID" id="QWeightID" value=<%=request("QWeightID")%>>  
                ...
                <!--#include file="Includes/Header.inc"-->
  				<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Add New Qualification Weight</strong></font></td>
                    </tr>
									...
									<td>
										<table width=100% border=0 cellpadding=0 cellspacing=0>
											...
											<tr class=columnheading height=22>
												...
												<td valign="middle" width=85%><input type="text" class="numberbox" name="txtType" id="txtType" width="3"></td>
											</tr>
											<tr class=columnheading height=22>
												<td valign="middle" width=2%>&nbsp;</td>
