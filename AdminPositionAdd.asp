...
<body>
<form  action="UpdatePosition.asp?strAction=<%=strAction%>&strTable=<%=strTable%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"-->
    	  ...
    	  <tr >
      		<td align="center" width=200 ><img alt="" src="images/spssites.gif" ></td>
       		<td  class=titlearea >Positions<BR>
       		  <span class="style1"><Font class=subheading>New Position Details</Font></span></td>
    	  </tr>
  		  <tr>
        	...
        	<td width=200 background="Images/tableback.png">
			  <table width=100% border=0 cellpadding=0 cellspacing=0 class=MenuStyleParent>
				...
				<tr height=20>
				  ...
				  <td align=Left bgcolor="#FFFFFF"><Div style="height:18px; border:Solid; border-width:1px; border-color:#438BE4; color: #003399;">New Position</Div></td>
				  <td align=Left  ></td>
				</tr>
			  </table>
			</td>
					...
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=76% >
						 <INPUT class="itemfont" style="WIDTH: 360px" maxLength="300" name="description" id="description" Value=""></td>
						<td valign="middle" width=2%></td>
					  </tr>
					  <tr height=16>
					    <td></td>
