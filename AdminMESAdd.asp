...
<form action="UpdateMES.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
  <input type="hidden" name="RankID" id="RankID" value="<%=request("MESID")%>"> 
  <Input id="HQTask" name="HQTask" type="hidden" value="0" > 
        ...
        <!--#include file="Includes/Header.inc"-->
  	    <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Add MES</strong></font></td>
                    </tr>
				  ...
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=95%><INPUT class="itemfont" style="WIDTH: 360px" maxLength="300" name="txtdescription" id="txtdescription" Value=""></td>
					  </tr>
					  <tr height=16>
					    <td></td>
					  </tr>
