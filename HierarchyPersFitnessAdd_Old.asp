...
<form action="AddFitness.asp" method="post" name="frmDetails">
	...
	<input type="hidden" name="ReturnTo" value="hierarchyPersFitnessAdd.asp"/>
	<input name="newexpirydateattached" type="hidden" value="">

	<table border=0 cellpadding=0 cellspacing=0 width=100%>
		<!--#include file="Includes/hierarchyStaffDetails.inc"--> 
		<tr>
			<td class=titlearealine  height=1><img height=1 alt="" src="../Images/blank.gif"></td> 
		</tr>
			...
			<td>
				<table border=0 cellpadding=0 cellspacing=0 >
					<tr>
						...
						<td height="25px" width="95" valign="middle" class=toolbar >Save and Close </td>
			...
			<td>
                <table border=0 cellpadding=0 cellspacing=0 width=100%>
					...
					<tr class=columnheading> 
						...
						<td align="left" width="25%" height="22px" class=itemfont><input type="checkbox" <%if rsRecSet("remedial") = true then response.write " checked "%> name=remedial value=1 onClick="frmDetails.exempt.checked=false; RemedialExempt();"></td>
						<td align="left" width="13%" height="22px">Exempt:</td>
						<td align="left" width="25%" height="22px" class=itemfont><input type="checkbox" <%if rsRecSet("exempt") = true then response.write " checked "%> name=exempt value=1 onClick="frmDetails.remedial.checked=false; RemedialExempt();"></td>
						<td align="left" width="22%" height="22px">&nbsp;</td>
					</tr>
					<tr class=columnheading> 
						<td align="left" width="2%" height="22px">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan=6 class=titlearealine height=1><img height=1 alt="" src="../Images/blank.gif"></td> 
                    </tr>
                </table>
                <table border=0 cellpadding=0 cellspacing=0 width=100%>
                    <tr class=SectionHeader>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                            <tr class="SectionHeader toolbar">
                                                <td height="25px" align="left">Fitness Type Available</td>
                                                <td height="25px">&nbsp;</td>
                                                <td height="25px" align="left">Fitness Types to Add</td>
                                            </tr>
                                            <tr>
					...
					<tr>
       					<td colspan=3 class=titlearealine  height=1><img height=1 alt="" src="../Images/blank.gif"></td> 
     				</tr>
			  	</table>
			</td>
		</tr>
		...
		<table border=0 cellpadding=0 cellspacing=0 width=100%>
			...
			<% if request("QTypeID")=2  then %>
				<tr class=columnheading>
					...
					<td align="left" height=22px class=itemfont>
						<select class="inputboxsearch itemfont" name=Competent>
			...
			<% else %>
				<tr class=columnheading>
					...
					<td align="left" height=22px class=itemfont><input type=hidden name=Competent value=N></td>
            		<td width="10%">&nbsp;</td>
				</tr>
    		<% end if %>
			<tr>
