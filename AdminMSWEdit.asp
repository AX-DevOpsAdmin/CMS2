      ...
      <td>
		...
		<table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>Edit Military Skills Weighting</strong></font></td>
                    </tr>
				...
				<tr height=16 class=SectionHeader>
				  <td>
					<table border=0 cellpadding=0 cellspacing=0 >
						...
						<td class=toolbar valign="middle" ><A class= itemfontlink href="AdminMSWDetail.asp?recID=<%=request("recID")%>">Back</A></td>											
					</table>
				  </td>
				</tr>
				<tr>
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85% class=itemfont><INPUT class="numberbox" width="3" maxLength="1" name="MSWType" id="MSWType" Value="<%=rsRecSet("MSWType")%>"></td>
					  </tr>
					  <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
						<td valign="middle" width="13%">Description:</td>
						<td valign="middle" width="85%" class=itemfont><INPUT class="itemfont" style="WIDTH: 340px" maxLength="50" name="Description" id="Description" Value="<%=rsRecSet("Description")%>"></td>
					  </tr>
					  <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
						<td valign="middle" width="13%">Weighting:</td>
						<td valign="middle" width="85%" class=itemfont><INPUT class="numberbox" width="3" maxLength=3 name="MSWValue" id="MSWValue" Value="<%=rsRecSet("MSWValue")%>"></td>
					  </tr>					  
					  <tr height=16>
						<td></td>
					  </tr>
