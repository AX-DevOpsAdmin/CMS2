...
<body>
<form action="UpdatePsTy.asp?strAction=<%=strAction%>&strTable=<%=strTable%>&strGoTo=<%=strGoTo%>" method="POST" name="frmDetails">
        ...
        <!--#include file="Includes/Header.inc"-->
  	    <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>New Task Type</strong></font></td>
                    </tr>
				  ...
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width=85%><INPUT name="description" class="itemfont" id="description" style="WIDTH: 360px" Value="" maxLength=300></td>
					  </tr>
                      <tr class=columnheading height=22>
			            <td valign="middle" width=2%>&nbsp;</td>
						<td valign="middle" width=13%>Task Colour:</td>
						<td valign="middle" width=85%><input name="txtcolor" id="txtcolor" type="text" class='color1' value="#FFFFFF"></td>
					  </tr>
					  <tr height=16>
					    <td></td>
					  </tr>
