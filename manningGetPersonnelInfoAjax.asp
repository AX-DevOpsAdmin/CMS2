...
<table border="0" cellpadding="0" cellspacing="0" width="580px" >
	<tr>
                    ...
                    <td width=200px>
                    	<Div class=borderArea style="background-color:#FFFFFF;">
                        	<table border=0 cellpadding=0 cellspacing=1>
                            	<tr>
                                	<td class=itemfont><%=rsRecSet("firstname")%>&nbsp;</td>
                                </tr>
                            </table>
						</Div>
					</td>
				...
				<tr class="personalDetails">
                    ...
                    <td width=200px>
                    	<Div class=borderArea style="background-color:#FFFFFF;">
                        	<table border=0 cellpadding=0 cellspacing=1>
                            	<tr>
                                	<td class=itemfont><%=rsRecSet("surname")%>&nbsp;</td>
                                </tr>
                            </table>
						</Div>
					</td>
				...
				<tr class="personalDetails">
                    ...
                    <td width=200px>
                    	<Div class=borderArea style="background-color:#FFFFFF;">
                        	<table border=0 cellpadding=0 cellspacing=1>
                            	<tr>
                                	<td class=itemfont><%=rsRecSet("knownas")%>&nbsp;</td>
                                </tr>
                            </table>
						</Div>
					</td>
				...
				<tr class="personalDetails">
                    ...
                    <td width=80px>
                    	<Div class=borderArea style="background-color:#FFFFFF;">
                        	<table border=0 cellpadding=0 cellspacing=1>
                            	<tr>
                                	<td class=itemfont><%=rsRecSet("Rank")%>&nbsp;</td>
                                </tr>
                            </table>
						</Div>
					</td>
		...
		<!--<td align=center><img width=200 height=200 src="getPhoto.asp?staffID=<%'=request("staffID")%>"></td>-->
    </tr>
</table>
