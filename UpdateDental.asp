...
IF strAction = "Update" THEN
    strCommand = "spDentalUpdate"
    strGoTo = "AdminDentalDetail.asp?recID=" & request("recID")
else  strAction = "Add" 
    strCommand = "spDentalInsert"
	strGoTo = "AdminDentalAdd.asp"
end if
...
if strAction = "Update" then
    set objPara = objCmd.CreateParameter ("dentalID",3,1,0, request("recID"))
    objCmd.Parameters.Append objPara
else
    ' default to generic 90SU Dental structure
