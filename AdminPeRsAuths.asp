...
'response.write session("authadmin")
'response.End()
                                    ...
                                    <td>
                                        <%' if strManager = "1" then %>
                                            <table border=0 cellpadding=0 cellspacing=0 >
                                                <tr>
                                                    <td height="25px" class=toolbar width=7></td><td width=19><a class=itemfontlink  href="AdminPersAuthAdd.asp?staffID=<%=request("staffID")%>&atpID=<%=request("atpID")%>"><img class="imagelink" src="images/editgrid.gif"></A></td>
                                                    <td width="123" height="25px" valign="middle" class=toolbar >Add Authorisation</td>
                                                    <td height="25px" class=titleseparator valign="middle" width=12 align="center">|</td>
                                                    
                                                    <td height="25px" width=19><a class=itemfontlink  href="AdminPersAuthRemove.asp?staffID=<%=request("staffID")%>&atpID=<%=request("atpID")%>"><img class="imagelink" src="images/delitem.gif"></A></td>
                                                    <td width="160" height="25px" valign="middle" class=toolbar >Remove Authorisation</td>
                                                    <td height="25px" class=titleseparator valign="middle" width=12 align="center">|</td>
                                                    
                                                    <td height="25px" class=toolbar width=7></td><td width=19><a class=itemfontlink  href="AdminPersAuthLimitAdd.asp?staffID=<%=request("staffID")%>&atpID=<%=request("atpID")%>"><img class="imagelink" src="images/editgrid.gif"></A></td>
                                                    <td width="140" height="25px" valign="middle" class=toolbar >Add  Assessor Right</td>
                                                    <td height="25px" class=titleseparator valign="middle" width=13 align="center">|</td>

                                                    <td height="25px" width=19><a class=itemfontlink  href="AdminPersAuthLimitDel.asp?staffID=<%=request("staffID")%>&atpID=<%=request("atpID")%>"><img class="imagelink" src="images/delitem.gif"></A></td>
                                                    <td width="160" height="25px" valign="middle" class=toolbar >Remove  Assessor Right</td>
                                                    <td height="25px" class=titleseparator valign="middle" width=12 align="center">|</td>

                                                  <td height="25px" width=713><a class=itemfontlink  href="AdminPersAuthSelect.asp?staffID=<%=request("staffID")%>">Back </a></td>
                                                ...
                                                <td width="98%" align="left" height="25px" colspan=5>
                                                    <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                                        <tr class="SectionHeader toolbar">
                                                            ...
                                                            <td width="10%" align="center" height="25px">Assessor Rights Held</td>
														...
														<% if rsAuths.recordcount > 0 then %>
                                                            <% do while not rsAuths.eof %>
                                                               <tr>
                                                                ...
                                                                <% if (rsAuths("limit") > 0 and strCurrent > 1) then strlim =1 end if %>
                                                                ...
                                                                <%'strAmberDate=strValidTo - 14 %>
                                                                    ...
                                                                    <% if rsAuths("authCode") <> "" then %>
                                                                        ...
                                                                        <%if strlim = 1 then %>                                                                        
                                                                            <td align="left" height="22px" class="toolbar" onClick="showlims(this, <%=rsRecSet("staffID")%>,<%=rsAuths("asrID")%>);"><a class="itemfontlink" ><%=rsAuths("authCode")%></a></td>
                                                                         <% else %>
...
function showlims(obj, staffID, asrID)
{
	//alert(staffID + " * " + authID);
	var strvars='staffID=' + staffID+ '&' + 'asrID='+asrID;
