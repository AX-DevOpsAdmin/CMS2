...
objCmd.CommandText = "spVacsAvailable"	'Name of Stored Procedure
...
<form action="AddVacs.asp" method="post" name="frmDetails">
	...
	<input type="hidden" name="ReturnTo" id="ReturnTo" value="HierarchyPersVacsAdd.asp"/>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <table border=0 cellpadding=0 cellspacing=0 width=100%>
                                            <tr class="SectionHeader toolbar">
                                                <td height="25px" align="left">Vaccinations Available</td>
                                                <td height="25px">&nbsp;</td>
                                                <td height="25px" align="left">Vaccinations to Add</td>
                                            </tr>
                                            <tr>
													...
													<select name="lstAttached" size="10" multiple class="pickbox" style="width:180px;" id="lstAttached" onChange="remAttached()">
														<% if not rsMSAvailableList.bof and not rsMSAvailableList.eof then %>
															<% do while not rsMSAvailableList.eof %>
																<option value=<%= rsMSAvailableList("MVid") %>><%= rsMSAvailableList("Description") %></option>
	...
	<div id="PopUpwindow1" class="PopUpWindow">
		<table border=0 cellpadding=0 cellspacing=0 width=100%>
			...
			<tr class=columnheading>
				...
				<td valign="middle" height="22px" width=30%>Vaccination:</td>
...
{	
	...
	else
	{
		...
		{
			errMsg += "Select Vaccinations Available";
