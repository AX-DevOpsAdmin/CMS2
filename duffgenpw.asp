...
if request("myHeight1") = "" then  
	%>
		<script language="JScript">
			...
			window.location = "duffgenpw.asp?myHeight1="+myHeight;
		</script>
	<%
else
   'session.timeout = 60
...
<body>
<form action="AdminHome.asp" method="POST" name="frmDetails">
    	...
    	<tr>
    		<td>
			  <!--#include file="Includes/Header.inc"-->  
                  ...
                  <td class=toolbar>Default password Change Error</td>
								</tr>
								<tr>
                                    <td>&nbsp;</td>
                                 </tr>
								...
								<tr>
                                    <td><div align="center" class="style19"><%=request("strError")%></div></td>
                                 </tr>
                                 <tr>
                                    <td>&nbsp;</td>
                                 </tr>
                                 <tr>
                                    <td>
                                      <div align="center" class="style19">You will be redirected to the System Administration screen shortly </div>
									</td>
                                 </tr>
                                 <tr>
