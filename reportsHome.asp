	...
	<table  height="100%" cellspacing=0 cellPadding=0 width=100% border=0>
    	<tr>    		
			...
			<% else %>  
				        <div class="indextiles">
        							<img src="cms_icons/png/64x64/network.png">
                        <div class="tilesheader"><a title="CAE 4000- MAP-01" href="reportsAuth4820B.asp">CAE 4000- MAP-01</a></br><p></p>
                        </div></div>
			<% end if %> 
			<div></div>
			<% end if %> 
           ...
           <% if session("sta") <> 0 then %>
		    <div></div>
			<% if location = "Reports" and subLocation="8" then %>				
			<% else %>  
				        <div class="indextiles">
        							<img src="cms_icons/png/64x64/database.png">
                        <div class="tilesheader"><a title="Staff Auth Limits" href="reportsStaffAuthLimitsList.asp">Staff Auth Limits</a></br><p></p>
                        </div></div>
			<% end if %> 
			<div></div>
			<% end if %>  
