...
<form action="UpdateCondF.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
  <input type="hidden" name="RecID" id="RecID" value="<%=request("cfID")%>">  
        ...
        <!--#include file="Includes/Header.inc"-->
  	   <table cellSpacing=0 cellPadding=0 width=100% border=0 >
                    <tr style="font-size:10pt;" height=26px>
                        ...
                        <td class="staticdatamenu"><font class="youAreHere">CMS Admin Menu / <strong>New Conditional Formatting</strong></font></td>
                    </tr>
				  ...
				  <td>
					<table width=100% border=0 cellpadding=0 cellspacing=0>
					  ...
					  <tr class=columnheading height=22>
						...
						<td valign="middle" width="85%"><input type="text" class="itemfont" id="txtdescription" name="txtdescription" style="WIDTH: 100px" height=""></td>
					  </tr>
					  <tr class=columnheading height=22>
                        <td valign="middle" width="2%">&nbsp;</td>
					    <td valign="middle" width="13%">Minimum %:</td>
						<td valign="middle" width="85%"><input type="text" class="decimalbox" id="txtmin" name="txtmin" width="3"></td>
					  </tr>
					  <tr class=columnheading height=22>
                        <td valign="middle" width="2%">&nbsp;</td>
					    <td valign="middle" width="13%">Maximum %:</td>
						<td valign="middle" width="85%"><input type="text" class="decimalbox" id="txtmax" name="txtmax" width="3"></td>
					  </tr>
					  <tr height=16>
					    <td></td>
					  </tr>
