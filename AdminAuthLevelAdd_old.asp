...
<form  action="UpdateAuthLevel.asp?strAction=<%=strAction%>" method="POST" name="frmDetails">
    <input type="hidden" name="lvlRankID" id="lvlRankID" value=""> 
                                    ...
                                    <td>
                                        <table border=0 cellpadding=0 cellspacing=0>
                                            <tr>
                                                ...
                                                <td class=toolbar valign="middle"><a class= itemfontlink href="AdminAuthLevelList.asp">Back</a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table width=100% border=0 cellpadding=0 cellspacing=0>
                                                ...
                                                <td valign="middle" width="9%">
                                                    <select class="itemfont" name="lvlID" id="lvlID">
                                                       ...
                                                       <%do while not rsLvl.eof%>
                                                            <option value=<%=rsLvl("lvlID")%> ><%=rsLvl("authlevel")%></option>
                                                            <%rsLvl.Movenext %>
                                                       <% loop%>
                                                    </select>
                                                 </td>  
                                            ...
                                            <tr class=columnheading height=22>
                                                <td valign="middle" width=0%>&nbsp;</td>
                                                <td valign="middle" width=14%>Administration Level Rank:</td>
                                                <td valign="middle" width="9%">
                                                    <select class="itemfont" name="rankID" id="rankID">
                                                        <option value=0>All</option>
                                                        <%do while not rsRank.eof%>
                                                            <option value=<%=rsRank("RankID")%>><%=rsRank("shortDesc")%></option>
                                                            <%rsRank.Movenext%>
                                                        <%loop%>
                                                    </select>
                                                </td>
                                                <td valign="middle" width=77%  style="color:#F00">&nbsp; <strong> NB: This is the MINIMUM rank allowed as an Administrator for this Auth Level</strong></td>
                                            </tr>
                                            <tr class=columnheading height=22>
                                                <td valign="middle" width=0%>&nbsp;</td>
                                                <td valign="middle" width=14%>Holding Level Rank:</td>
                                                <td valign="middle" width="9%">
                                                    <%rsRank.Movefirst %>
                                                ...
                                                <td valign="middle" width=77%  style="color:#F00">&nbsp; <strong> NB: This is the MINIMUM rank allowed to be granted this Authorisation</strong></td>
